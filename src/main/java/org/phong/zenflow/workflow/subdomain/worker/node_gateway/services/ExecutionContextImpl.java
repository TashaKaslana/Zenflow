...
public class ExecutionContextImpl implements ExecutionContext {
    ...
    public void write(String key, Object value, WriteOptions options) {
        ...
        if (runtimeContext != null) {
            ...
            runtimeContext.write(key, value, effective, contextAccessPolicy);
        }
    }
     ...
     * functions. Callers must {@link TemplateService.ImmutableEvaluator#cloneInstance() clone}
    ...
    public Map<String, Object> getCurrentNodeEntrypoint() {
        Map<String, Object> entrypoint = runtimeContext != null
                ? (Map<String, Object>) runtimeContext.get(ExecutionContextKey.ENTRYPOINT_LIST_KEY + nodeKey)
                : null;
        if (entrypoint != null) {
            return entrypoint;
        }
    ...
    public Object getProfileSecret(String key) {
        Map<String, Object> profiles = (Map<String, Object>) runtimeContext.get(ExecutionContextKey.PROFILE_KEY.key());
        if (profiles == null) {
            return null;
        }
    ...
    public Object getSecret(String key) {
        Map<String, Object> secretsList = (Map<String, Object>) runtimeContext.get(ExecutionContextKey.SECRET_KEY.key());
    ...
    public boolean containsKey(String key) {
        ...
        return runtimeContext != null && runtimeContext.containsKey(key);
    }
    ...
    public void writeAll(Map<String, Object> values, WriteOptions options) {
        ...
        for (Map.Entry<String, Object> entry : values.entrySet()) {
            runtimeContext.write(entry.getKey(), entry.getValue(), effective, contextAccessPolicy);
        }
    }
    ...
    public void writeAllEntries(Map<String, ExecutionOutputEntry> entries) {
        ...
        for (Map.Entry<String, ExecutionOutputEntry> entry : entries.entrySet()) {
            ...
            runtimeContext.write(outputEntry.key(), outputEntry.value(), effective, contextAccessPolicy);
        }
    }
    ...
    public InputStream openStream(String key) throws IOException {
        ...
        return runtimeContext.openStream(key);
    }
    ...
    public void writeStream(String key, InputStream inputStream, WriteOptions options) throws IOException {
        ...
        WriteOptions effective = normalizeWriteOptions(options);
        runtimeContext.writeStream(key, inputStream, effective, contextAccessPolicy);
    }
