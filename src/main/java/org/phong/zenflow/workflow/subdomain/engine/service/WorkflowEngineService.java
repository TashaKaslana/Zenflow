...
public class WorkflowEngineService {
    ...
    private final NodeExecutionMediator nodeExecutionMediator;
    ...
    private WorkflowExecutionStatus getWorkflowExecutionStatus(UUID workflowId,
        ...
        while (workingNode != null) {
            ...
            switch (result.getStatus()) {
                case SUCCESS:
                    workingNode = navigatorSuccess(workflowId, workingNode, workflowNodes);
                    break;
                case ERROR:
                ...
                case WAITING:
                    ...
                    break;
                case NEXT:
                    workingNode = navigatorNext(workflowId, result, workflowNodes);
                    break;
    ...
    private ExecutionResult executeWorkingNode(Map<UUID, PluginNode> pluginNodes,
        ...
        if (workingNode.getType() == NodeType.PLUGIN) {
            ...
            result = nodeExecutionMediator.executeWithStateManagement(pluginNode, resolvedConfig, workingNode.getKey(), context);
        } else {
