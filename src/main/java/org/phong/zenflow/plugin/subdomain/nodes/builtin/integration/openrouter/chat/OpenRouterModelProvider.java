...
public class OpenRouterModelProvider implements AiModelProvider {
    ...
    public OpenRouterModelProvider(OpenAiChatModel chatModel,
    ...
    public AiExecutionResult execute(AiExecutionRequest request) {
        log.debug("Executing OpenRouter API with {} messages, {} tools, format: {}",
        ...
        log.debug("Received response from OpenRouter API: {} chars", rawResponse != null ? rawResponse.length() : null);
