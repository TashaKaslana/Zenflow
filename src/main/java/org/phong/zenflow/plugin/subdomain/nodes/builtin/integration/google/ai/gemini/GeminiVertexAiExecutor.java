...
@Component
@Slf4j
public class GeminiVertexAiExecutor implements NodeExecutor {
    
    private final AiExecutor baseExecutor;
    private final AiToolRegistry toolRegistry;
    private final AiObservationRegistry observationRegistry;

    public GeminiVertexAiExecutor(ObjectMapper objectMapper,
        ...
        log.info("Gemini Vertex executor initialized with {} tools (independent copy)", this.toolRegistry.size());
        ...
        this.baseExecutor.setModelProviderFactory(context -> {
            ...
            return new GeminiVertexModelProvider(chatModel, objectMapper);
        });
    }
